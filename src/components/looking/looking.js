        ...
        return (
            <div>
                <form onSubmit={this.onSubmitClick}>
                    <div>
                        <div className="form-check col-md-12 form-check-inline text-center">
                ...
                <h3 className="text-center">Below section best viewed on a computer screen</h3>
                {/* <h3 className="text-center">Need a partner? Send an email to <a href="mailto:kyle.savant@batonrougepickleball.com"><i className="fa fa-envelope-o"> kyle.savant@batonrougepickleball.com</i></a></h3>  */}
                <hr style={{ backgroundColor: "black", borderWidth: "4px", width: "100%" }} />
                {
